...
def analyze_issues_csv_monthly(csv_file):
    ...
    try:
        ...
        all_comments_column = 'All Comments'  #Coluna com todos os comentários
        authors_column = 'Authors' #Colunas com autores

        # Verifique se as colunas existem
        if not all(col in df.columns for col in [created_at_column, title_column, description_column, all_comments_column, authors_column]):
        ...
        for month, group in grouped:
            ...
            for index, row in group.iterrows():
                ...
                comments = row[all_comments_column] #Assume que a coluna que contem os comentarios se chama 'All Comments'
                authors = row[authors_column] #Assume que a coluna que contem os autores se chama 'Authors'
                ...
                all_comments.extend(comments.split(" | ")) #Adiciona os comentarios a lista
                all_authors.extend(authors.split(", "))  #Adiciona os autores a lista
...
def main():
    ...
    output_file = "rotatividade_desenvolvedores.txt"  # Nome do arquivo TXT de saída
